...
namespace Sarjee.SimpleRenamer.L0.Tests.Mocks
{
    internal class TestableTvdbManager : TvdbManager
    {
        ...
        private const string _searchResponse = "[{\"aliases\":[\"string\"],\"banner\":\"string\",\"firstAired\":\"string\",\"id\":0,\"network\":\"string\",\"overview\":\"string\",\"seriesName\":\"Castle\",\"status\":\"string\"},{\"aliases\":[\"string\"],\"banner\":\"string\",\"firstAired\":\"string\",\"id\":0,\"network\":\"string\",\"overview\":\"string\",\"seriesName\":\"KillJoys\",\"status\":\"string\"}]";
